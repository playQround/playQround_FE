...
const SearchArea = () => {
    ...
    const SearchStart = () => {
        axios.get(`http://localhost:3000/api/rooms/search?roomName=${searchRoomName}&roomStatus=${selectRoomStatus}&maxPeople=${people}&cutRating=${rating}`)
            ...
            <div className='SelectArea'>
                <div id="SearchForm">
                    <input type="text" placeholder="Search" 
                        onChange={SearchRoomNameTrack} value={searchRoomName}/>
